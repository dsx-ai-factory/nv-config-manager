...
class ReservationPageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["next_cursor", "reservations", "total_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReservationPageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReservationPageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "reservations": [ReservationRecord.from_dict(_item) for _item in obj["reservations"]] if obj.get("reservations") is not None else None,
