...
class LeasePageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["leases", "next_cursor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LeasePageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LeasePageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "leases": [LeaseRecord.from_dict(_item) for _item in obj["leases"]] if obj.get("leases") is not None else None,
