...
class PoolPageResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["next_cursor", "pools", "total_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PoolPageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PoolPageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pools": [PoolRecord.from_dict(_item) for _item in obj["pools"]] if obj.get("pools") is not None else None,
