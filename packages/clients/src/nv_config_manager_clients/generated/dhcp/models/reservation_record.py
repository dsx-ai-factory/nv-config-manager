...
class ReservationRecord(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hostname", "identifier", "identifier_type", "ip_address", "subnet"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReservationRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReservationRecord from a dict"""
        if obj is None:
            return None
