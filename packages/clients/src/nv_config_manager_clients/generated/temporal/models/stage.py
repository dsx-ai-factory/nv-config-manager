...
class Stage(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "approval_threshold": obj.get("approval_threshold")
                if obj.get("approval_threshold") is not None
                else 0,
                "approvers": [Review.from_dict(_item) for _item in obj["approvers"]]
                ...
                "rejecters": [Review.from_dict(_item) for _item in obj["rejecters"]]
                if obj.get("rejecters") is not None
                else None,
                ...
                "state": obj.get("state"),
                "state_history": [HistoryEntry.from_dict(_item) for _item in obj["state_history"]]
                if obj.get("state_history") is not None
                else None,
