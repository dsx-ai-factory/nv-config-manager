...
class SpXOverlayAssignmentInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["device", "namespace_tag", "overlay_id", "port_names", "site", "site_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": Device1.from_dict(obj["device"]) if obj.get("device") is not None else None,
