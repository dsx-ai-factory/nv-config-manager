...
class WorkflowMetadataResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowMetadataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowMetadataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "workflows": [WorkflowMetadata.from_dict(_item) for _item in obj["workflows"]] if obj.get("workflows") is not None else None
        })
