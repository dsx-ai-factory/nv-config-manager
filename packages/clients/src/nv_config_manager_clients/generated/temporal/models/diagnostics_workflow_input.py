        ...
        _obj = cls.model_validate(
            {
                ...
                "include_tech_support": obj.get("include_tech_support")
                if obj.get("include_tech_support") is not None
                else False,
                "issue_key": obj.get("issue_key") if obj.get("issue_key") is not None else "",
                "ticketing_platform": obj.get("ticketing_platform")
                if obj.get("ticketing_platform") is not None
                else "",
