...
class SiteBackupInput(BaseModel):
    ...
    backup_enabled_only: Optional[StrictBool] = Field(
        default=True, description="When true, only devices with backup enabled are included."
    )
    roles: Optional[List[StrictStr]] = Field(
        default=None, description="Device roles used to filter the selected network devices."
    )
    site: Annotated[str, Field(min_length=1, strict=True)] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SiteBackupInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SiteBackupInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "backup_enabled_only": obj.get("backup_enabled_only")
                if obj.get("backup_enabled_only") is not None
                else True,
                "roles": obj.get("roles"),
                "site": obj.get("site"),
