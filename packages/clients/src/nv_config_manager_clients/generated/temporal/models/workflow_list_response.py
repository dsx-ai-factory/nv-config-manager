...
class WorkflowListResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["next_page_token", "page_count", "total_count", "workflows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflows": [WorkflowSummaryResponse.from_dict(_item) for _item in obj["workflows"]] if obj.get("workflows") is not None else None
        })
