...
SEARCHATTRIBUTESVALUE_ANY_OF_SCHEMAS = [
    "List[bool]",
    "List[datetime]",
    "List[float]",
    "List[int]",
...
class SearchAttributesValue(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[
            Union[List[bool], List[datetime], List[float], List[int], List[str]]
        ] = None
    else:
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in SearchAttributesValue with anyOf schemas: List[bool], List[datetime], List[float], List[int], List[str]. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into SearchAttributesValue with anyOf schemas: List[bool], List[datetime], List[float], List[int], List[str]. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
    ...
    def to_dict(
        ...
        Union[Dict[str, Any], List[bool], List[datetime], List[float], List[int], List[str]]
    ]:
