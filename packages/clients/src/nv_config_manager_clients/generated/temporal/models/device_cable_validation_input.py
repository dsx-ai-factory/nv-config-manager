...
class DeviceCableValidationInput(BaseModel):
    ...
    device: Optional[NetworkDeviceData] = Field(
    ...
    ignore_no_neighbor: Optional[StrictBool] = Field(
        default=False,
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceCableValidationInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceCableValidationInput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "device": NetworkDeviceData.from_dict(obj["device"])
                if obj.get("device") is not None
                else None,
                "device_id": obj.get("device_id"),
                "ignore_no_neighbor": obj.get("ignore_no_neighbor")
                if obj.get("ignore_no_neighbor") is not None
                else False,
            }
        )
