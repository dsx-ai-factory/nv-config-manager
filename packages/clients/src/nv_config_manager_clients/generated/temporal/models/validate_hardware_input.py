...
class ValidateHardwareInput(BaseModel):
    ...
    """ # noqa: E501
    device_type_ids: Optional[List[StrictStr]] = Field(default=None, description="Device type identifiers used to filter network devices.")
    raise_for_invalid: Optional[StrictBool] = Field(default=False, description="Whether invalid hardware should fail the workflow.")
