...
class SpXOverlayCreationInput(BaseModel):
    ...
    overlay_id: StrictStr = Field(description="Unique identifier for the SpX overlay. Used as an idempotency key — re-running with the same ID returns existing VRFs without creating new ones.")
