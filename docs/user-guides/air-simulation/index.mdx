...
`http-lb`; default rendered-configuration and certificate transfers appear in
`sftp`. For the full production workflow details, see
[Device Reprovision](../reprovision/index.mdx).
