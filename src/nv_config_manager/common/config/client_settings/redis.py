...
"""INI settings adapter for Redis clients."""
...
class RedisSettings(TypedDict):
    """Constructor settings for ``nv_config_manager_infrastructure.RedisClient``."""
...
def redis_settings(
    ...
    *,
    ...
    """Translate the Redis INI section into constructor settings."""
