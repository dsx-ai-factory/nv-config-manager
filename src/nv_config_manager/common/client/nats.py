...
from nv_config_manager_workflows.clients.nats import NatsClient as WorkflowNatsClient
from nv_config_manager_workflows.clients.nats import NatsProducer as WorkflowNatsProducer

logger = get_logger(__name__, category=LogCategory.NATS)


class NatsClient(WorkflowNatsClient):
    """Compatibility adapter retaining configuration-backed construction."""
...
class NatsProducer(WorkflowNatsProducer, NatsClient):
