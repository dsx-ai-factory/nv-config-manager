...
"""Service adapters for legacy cumulus connections."""
...
class CumulusConnection(NetworkConnection, WorkflowCumulusConnection):
    """Retain the service constructor while inheriting workflow behavior."""

    DEFAULT_PORT = 8765


class NVOSConnection(CumulusConnection, WorkflowNVOSConnection):
    """Retain the service constructor while inheriting workflow behavior."""
