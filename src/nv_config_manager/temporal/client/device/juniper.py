...
"""Service compatibility adapter for the workflow-owned Junos client."""
...
from nv_config_manager_workflows.clients.device.juniper import (
    _junos_list as _junos_list,
)
from nv_config_manager_workflows.clients.device.juniper import (
    _junos_string as _junos_string,
)
from nv_config_manager_workflows.clients.device.juniper import (
...
class JuniperConnection(NetworkConnection, _JuniperConnection):
    """Junos client using service-owned configuration resolution."""

    DEFAULT_PORT = 830

    @property
    def _device_factory(self) -> Any:
        """Use the service module's patch-compatible PyEZ constructor."""
        return Device

    @property
    def _config_factory(self) -> Any:
        """Use the service module's patch-compatible config context."""
        return Config
